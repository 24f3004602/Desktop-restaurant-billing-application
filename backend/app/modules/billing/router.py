...
from app.modules.billing.schemas import BillGenerateRequest, BillRead
from app.modules.billing.service import generate_bill, get_bill
...
def create_bill(
    ...
    return generate_bill(db, order_id, payload, current_user.id)
